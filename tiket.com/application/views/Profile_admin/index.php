   ...
   <div class="row" style="padding: 40px">
	<div class="col-3 mx-auto" style="border: solid .5px #ddd;border-radius: 5px;background-color: white;">
		<div class="row" style="margin-bottom: 10px; margin-top: 10px;">
				...
				<div class="col">
					<a id="a1" href="#">
						<span style="margin-left: 10px;">Profil Admin</span>
					</a>
				</div>
		...
		<div class="row" style="margin-bottom: 10px;">
				...
				<div style="color: black" class="col">
					<a id="a" href="#">
						<span style="margin-left: 10px;">Kelola Pesawat</span>
					</a>
				</div>
		...
		<div class="row" style="margin-bottom: 10px;">
				...
				<div style="color: black" class="col">
					<a id="a" href="#">
						<span style="margin-left: 10px;">Kelola Hotel</span>
					</a>
				</div>
		...
		<div class="row" style="margin-bottom: 10px;">
				...
				<div style="color: black" class="col">
					<a id="a" href="#">
						<span style="margin-left: 10px;">Kelola User</span>
					</a>
				</div>
